...
- [docs/product/prd.md](../../product/prd.md) — product scope
- [docs/architecture/tech_stack.md](../../architecture/tech_stack.md) — stack choices
- [docs/architecture/backend.md](../../architecture/backend.md) — structure and conventions
- [docs/architecture/schema.md](../../architecture/schema.md) — intended data model (runtime source of truth is `famcare-backend/prisma/schema.prisma`)
- [docs/decisions/DECISION_LOG.md](../../decisions/DECISION_LOG.md) — **scope changes, spec drift, and meaningful bugfix behavior** (keep in sync when you diverge from plan or PRD)
- [docs/operations/GO_LIVE_CHECKLIST.md](../../operations/GO_LIVE_CHECKLIST.md) — **pre-production verification** (what to still check or run before go-live)
